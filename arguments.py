...
def get_args():
    ...
    parser.add_argument('--two-heads', action='store_true', default=False,
                        help='separate translation and rotation heads (default: False)')
    ...
    parser.add_argument('--intrinsic-kitti', action='store_true', default=False,
                        help='transform tartan image to kitti to match the intrinsic value (default: False)')
    ...
    parser.add_argument('--data-file2', default='train.txt,kitti.txt',
                        help='txt file specify the training data (default: "")')

    parser.add_argument('--val-file2', default='val.txt',
                        help='txt file specify the validation data (default: "")')
