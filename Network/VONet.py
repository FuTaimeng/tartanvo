...
class MultiCamVONet(nn.Module):
    def __init__(self, flowNormFactor=1.0, fix_parts=("flow"), stereo=2.1, sep_feat=True,trunk_value=1e-1):
        ...
        from .VOFlowNet import VOFlowRes as FlowPoseNet
        self.flowPoseNet = FlowPoseNet(intrinsic=True, down_scale=True, config=1, stereo=stereo, fix_parts=fix_parts, sep_feat=sep_feat,trunk_value = trunk_value)
